...
{
    public class BlueBullTrailSyncManager : MonoBehaviour
    {
        ...
        private static BlueBullTrailSyncManager _instance;

        public static BlueBullTrailSyncManager Instance => _instance;
